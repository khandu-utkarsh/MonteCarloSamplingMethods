...
#resultsD = Parallel(n_jobs=len(sampleSizes))(delayed(runProcessGibbs)(i) for i in sampleSizes)
resultsR = Parallel(n_jobs=len(sampleSizes))(delayed(runProcessMH)(i) for i in sampleSizes)